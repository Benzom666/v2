...
/**
 * Mobile Step 1: Experience Selection
 * Full-width cards with large touch targets for mobile
 */
const Step1ExperienceMobile = () => {
        ...
        <div className="create-date-shell create-date-mobile">
          ...
          <div className="create-date-content">
            ...
            <div className="date-class-section choose-gender step-1 experience-section">
              <div className="inner_container mobile-experience-container">
                {EXPERIENCE_GROUPS.map((group, groupIndex) => (
                  <div className="experience-group" key={groupIndex}>
                    ...
                    <div
                      className={`experience-grid mobile-experience-grid ${
                      ...
                      {group.options.map((option) => {
                        ...
                        return (
                          <button
                            type="button"
                            key={option.id}
                            className={`experience-card mobile-experience-card ${
...
export default Step1ExperienceMobile;
